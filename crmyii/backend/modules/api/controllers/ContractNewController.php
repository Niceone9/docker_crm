...
use backend\models\ContractNew as Contract;
use backend\components\Quanxian;



class ContractNewController extends ActiveController
{
    public $modelClass='backend\models\ContractNew';
    ...
    public function actionShenhe1($id){
        ...
        try {
            ...
            $this->global_audit($id,'contract_new',1,'contract_new');
    ...
    public function actionShenhe2($id){
        $tr = \Yii::$app->db->beginTransaction();
        try {
            $this->global_audit($id,'contract_new',2,'contract_new');
    ...
    public function actionShenhe3($id){
        $this->global_audit($id,'contract_new',3,'contract_new');
    ...
    public function actionShenhe4($id){
        $this->global_audit($id,'contract_new',4,'contract_new');
    ...
    public function actionShenhe5($id){
        $this->global_audit($id,'contract_new',5,'contract_new');
