...
class DepartmentController extends ActiveController
{
    ...
    {
        $cateInfo = Department::bumen_list();
        // var_dump($cateInfo);
        return $cateInfo;
    }
    ...
    public function actionBumenusers($id){
        //获取部门下面的-递归
        $inid=\Yii::$app->hjd->bumen_users($id);
        //只获取这个部门的

        $list=Department::bumenuserslist($inid);
        return $list;
    }
    ...
    public function actionBumen_info($id){
        $data['code']='200';
