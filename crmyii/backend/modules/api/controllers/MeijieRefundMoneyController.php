...
class MeijieRefundMoneyController extends ActiveController
{
    ...
    public function actionList(){
        $data['code']=200;
        $data['data']=MrenewHuikuan::tuikuan_list();
        return $data;
    }
    ...
    public function actionAddru(){
        ...
        $model->payment_type=17;

            //退款到客户如果合同余额不够退款金额 不让退款
            $conyue=$contract_info['dakuan']-$contract_info['yu_e'];
    ...
    public function actionShenhe1($id){
        ...
        try {
            //写入历史记录
            $this->global_audit($id,'meijie-refund-money',1,'jd_mrenew_huikuan');
            //审核续费后续
            MrenewHuikuan::tuikuan_shenhe($id,1);
            $tr1->commit(); //提交数据
    ...
    public function actionShenhe2($id){
        ...
        try {
            //写入历史记录
            $this->global_audit($id,'meijie-refund-money',2,'jd_mrenew_huikuan');
            //审核续费后续
            MrenewHuikuan::tuikuan_shenhe($id,2);
            $tr1->commit(); //提交数据
        } catch (Exception $e) {
            //回滚
            $tr1->rollBack();
    ...
    public function actionShenhe3($id){
        ...
        try {
            //写入历史记录
            $this->global_audit($id,'meijie-refund-money',3,'jd_mrenew_huikuan');
            //审核续费后续
            MrenewHuikuan::tuikuan_shenhe($id,3);
            $tr1->commit(); //提交数据
        } catch (Exception $e) {
            //回滚
            $tr1->rollBack();
    ...
    public function actionShenhe4($id){
        ...
        try {
            //写入历史记录
            $this->global_audit($id,'meijie-refund-money',4,'jd_mrenew_huikuan');
            //审核续费后续
            MrenewHuikuan::tuikuan_shenhe($id,4);
            $tr1->commit(); //提交数据
        } catch (Exception $e) {
            //回滚
            $tr1->rollBack();
    ...
    public function actionShenhe5($id){
        ...
        try {
            //写入历史记录
            $this->global_audit($id,'meijie-refund-money',5,'jd_mrenew_huikuan');
            //审核续费后续
            MrenewHuikuan::tuikuan_shenhe($id,5);
            $tr1->commit(); //提交数据
        } catch (Exception $e) {
            //回滚
            $tr1->rollBack();
    ...
    public function actionRefundmoney_info($id){
        ...
        $data['data']=MrenewHuikuan::tuikuaninfo($id);
        $data['code']=200;
        return $data;
    }
}
