...
class WaichuController extends ActiveController
{
    public $modelClass='backend\models\Waichu';
    ...
    //回款详情
    public function actionWaichu_info($id){
        $data['code']='200';
        $data['data']=Waichu::waichu_info($id);
        return $data;
    }
